...
const App = () => {
  const [setMushroomShortData] = useStateWithLabel('mushroomShortData', '');
  useEffect(() => {
    // console.log(getShortDataMushroom();
    // console.log(mushroomShortData);

    async function getData() {
      (await getShortDataMushroom()).map((v) =>
        setMushroomShortData({
          anotherNames: v.anotherNames,
